...
export default function App(){
 ...
 </Suspense></main><footer className="wrap footer"><a className="brand" href={siteRoot}>Cellpinda.</a><p>잠과 휴식에 대해 알아보고, 내게 맞는 선택을 해보세요.</p><a href={`${siteRoot}?view=guide`}>GABA 안내서</a><a href="https://smartstore.naver.com/cellpinda/products/4701017202" target="_blank" rel="noopener noreferrer">스마트스토어 제품 보기 ↗</a><a href={`${siteRoot}?view=account`}>내 기록</a><Suspense fallback={null}><AnalyticsConsent enabled={apiEndpoint('/api/events') !== null}/></Suspense></footer></>;
}
