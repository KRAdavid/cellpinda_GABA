...
export default function App(){
 ...
 useEffect(()=>{
  ...
  if(!type&&!focusInvite)return;
   const title=focusInvite ? '너도 해봐 · 1분 신호 반응 게임 | 셀핀다' : `공유받은 하루 리듬: ‘${type!.name}’ | Cellpinda`;
   const description=focusInvite ? '친구가 보낸 1분 신호 반응 게임이에요. 점수는 건강 상태가 아닌 게임 기록이에요.' : `친구가 고른 ‘${type!.name}’ 장면을 공유했어요. 내 체크 결과는 아니에요.`;
