...
export default function ProductShare({onEvent}:Props){
 ...
 async function share(){
  ...
  try{
   ...
   await navigator.share({title:'셀핀다 가바 1500 제품 정보',text:'1포 내용량과 포장 구성을 함께 확인해 보세요.',url:link()});
 ...
 return <aside className="product-share" aria-labelledby="product-share-heading"><div><h3 id="product-share-heading">가족·친구와 함께 확인해 보세요.</h3><p>1포 내용량과 포장 구성을 함께 확인할 사람에게 보내세요.</p></div><div>
