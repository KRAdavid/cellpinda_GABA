...
const scenes: SceneDefinition[] = [
  {
    ...
    icon: Moon,
    tone: 'sleep',
    factKeys: [['sampleSize', '참여한 사람'], ['dose', '먹은 양'], ['duration', '살펴본 기간']],
  },
  {
    ...
    icon: Brain,
    tone: 'stress',
    factKeys: [['sampleSize', '참여한 사람'], ['dose', '먹은 양'], ['duration', '살펴본 시점']],
  },
  {
    ...
    label: '집중',
    badge: '몸속 신호 관찰',
    title: '반복 자극 뒤 감각 변화를 살펴본 연구',
    fallbackSummary: '뇌 속 GABA 신호와 반복 자극 뒤 감각 변화를 관찰한 연구예요.',
    icon: Sparkles,
    tone: 'focus',
    factKeys: [['sampleSize', '참여한 사람'], ['dose', '먹은 양'], ['duration', '살펴본 방법']],
  },
  {
    id: 'gaba-definition',
    number: '04',
  ...
  return (
    <section id="gaba-evidence" className="section wrap gaba-evidence" aria-labelledby="gaba-evidence-title">
      <div className="section-head gaba-evidence-head">
        <div>
          <p className="chapter">02 / GABA를 살펴본 장면</p>
          <h2 id="gaba-evidence-title">영상 다음,<br />네 가지 장면을 쉽게 보세요.</h2>
        </div>
        <p>각 연구에서 누구에게 무엇을 물었는지부터<br />짧고 쉽게 확인해 보세요.</p>
      </div>
      ...
      <p className="gaba-evidence-note">카드의 숫자는 각 연구에서 사용한 조건입니다. 셀핀다 제품을 고를 때는 제품 표시를 따로 확인하세요.</p>
