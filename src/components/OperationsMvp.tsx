...
type QueueTask = {id: string; stream: string; title: string; state: string; lead: string; verifier: string; decision: string; decisionMode: string; nextAction: string; decisionOptions?: {id: string; label: string; criteria: string[]}[]; blockedBy?: string; requiredInputs?: string[]; dependencies: string[]};
...
type GoalAuditGate = {id: string; title: string; state: string; lead: string; verifier: string; requiredInputs: string[]; decision: string; decisionMode: string; nextAction: string; decisionOptions: {id: string; label: string; criteria: string[]}[]};
