...
type QueueTask = {id: string; stream: string; title: string; state: string; lead: string; verifier: string; decision: string; decisionMode: string; nextAction: string; blockedBy?: string; requiredInputs?: string[]; dependencies: string[]};
