...
export default function GabaStory({claims, hasReviews = false}:{claims:Claim[]; hasReviews?: boolean}) {
  ...
  return <section id="story" className="section sage"><div className="wrap">
    ...
    <div className="story-questions" style={{marginTop:48}}><h3>읽다가 떠오르는 질문</h3>
      ...
      <details className="claim"><summary>연구 결과를 셀핀다 제품 정보와 어떻게 비교하나요?</summary><div><p>먼저 연구에서 누구를 대상으로 무엇을 살펴봤는지 확인해 보세요. 각 연구 카드는 쉬운 말과 도표로 정리하고, 더 궁금한 숫자와 출처는 펼쳐 볼 수 있어요.</p><a className="text-link" href="#research">연구 카드에서 쉽게 보기 →</a></div></details>
