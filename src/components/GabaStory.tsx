...
export default function GabaStory({claims, hasReviews = false}:{claims:Claim[]; hasReviews?: boolean}) {
  ...
  return <section id="story" className="section sage"><div className="wrap">
    ...
    <div className="story-steps">
      ...
      <article><span>2</span><div><h3>사람 연구는 어디서 볼 수 있나요?</h3><p>잠, 뇌파, 운동 연구를 아래에서 한 번씩 확인할 수 있어요. 누가 참여했고 무엇을 측정했는지 그림과 쉬운 말로 보여드려요.</p><a className="text-link" href="#research">사람 연구 살펴보기 →</a></div></article>
