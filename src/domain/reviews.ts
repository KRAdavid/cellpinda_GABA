...
export const REVIEW_DESTINATION_TEXT='가바 1500 구매자 후기를 스마트스토어에서 읽어보세요.';
export const SMARTSTORE_PRODUCT_URL='https://smartstore.naver.com/cellpinda/products/4701017202';
export const REVIEW_DESTINATION_URL=`${SMARTSTORE_PRODUCT_URL}#REVIEW_DIALOG`;
