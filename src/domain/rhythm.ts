...
export const questions: readonly RhythmQuestion[] = [
  {
    id: 'tension',
    prompt: '지난 7일, 하루 일과가 끝난 뒤에도 할 일이 계속 떠올랐나요?',
    helper: '퇴근·집안일 뒤에도 머리가 쉬지 않았는지 생각해 보세요.',
    options: [
  ...
  {
    id: 'sleep-transition',
    prompt: '지난 7일, 침대에 누운 뒤 잠들기까지 오래 걸렸나요?',
    helper: '잠자리에 든 시각과 실제로 잠든 때를 떠올려 보세요.',
    options: [
  ...
  {
    id: 'pause',
    prompt: '지난 7일, 5분이라도 아무 일 하지 않고 쉬었나요?',
    helper: '일·집안일 중간에 일부러 멈춘 시간이 있었는지 생각해 보세요.',
    options: [
  ...
  {
    id: 'sensory-load',
    prompt: '지난 7일, 사람 많은 곳이나 화면을 본 뒤 예민하거나 멍했나요?',
    helper: '소리·빛·대화를 줄이고 싶었던 때가 있었는지 떠올려 보세요.',
    options: [
      { value: 0, label: '거의 없었어요' },
  ...
  {
    id: 'morning-recovery',
    prompt: '지난 7일, 아침에 일어나도 피곤했나요?',
    helper: '잠을 잔 뒤 바로 움직일 힘이 있었는지 돌아보세요.',
    options: [
...
export const resultTypes: Readonly<Record<RhythmId, RhythmType>> = {
  active: {
    id: 'active',
    name: '머리가 계속 바쁜 날',
    description: '하루 일과가 끝난 뒤에도 할 일이 계속 떠오르는 날이 많았어요.',
    suggestions: ['내일 할 일을 짧게 적고 오늘의 일을 마무리해 보세요.', '저녁에 화면과 알림을 잠시 내려놓는 시간을 정해 보세요.'],
    recoveryLevel: 'prioritize',
    recoveryHeading: '오늘은 일을 내려놓는 시간을 먼저 정해 보세요',
    recoveryDescription: '하루가 끝난 뒤에도 생각이 계속됐다면 GABA가 뇌에서 신경세포 사이의 신호를 조절하는 물질이라는 설명을 참고해 보세요. 저녁 알림을 끄고 10분 쉬는 시간을 먼저 정해 보세요.',
  },
  sleep: {
    id: 'sleep',
    name: '잠들기 어려운 날',
    description: '침대에 누운 뒤에도 잠들기까지 오래 걸리는 날이 많았어요.',
    suggestions: ['잠들기 전 같은 순서로 조명·화면·호흡을 낮추는 루틴을 만들어 보세요.', '잠자리에서 해결할 일은 메모장에 맡기고 내일로 미뤄 보세요.'],
    recoveryLevel: 'prioritize',
    recoveryHeading: '잠자리에 들기 전 준비 시간을 만들어 보세요',
    recoveryDescription: '잠들기까지 오래 걸린 날이 있었다면 조명을 낮추고 내일 할 일을 메모한 뒤 침대에 들어가 보세요. GABA가 뇌의 신경세포 사이 신호를 조절한다는 설명도 함께 확인할 수 있어요.',
  },
  irregular: {
    id: 'irregular',
    name: '쉴 틈이 없는 날',
    description: '일과 집안일 사이에 아무 일 하지 않고 쉬는 시간이 거의 없었어요.',
    suggestions: ['일정표에 5분짜리 멈춤을 하나 넣고 알림을 설정해 보세요.', '휴식 시간에는 화면 대신 물·호흡·창밖 보기처럼 자극이 적은 행동을 골라 보세요.'],
    recoveryLevel: 'prioritize',
    recoveryHeading: '5분이라도 쉬는 시간을 달력에 넣어 보세요',
    recoveryDescription: '쉴 시간이 늘 생기지는 않아요. 하루 중 비어 있는 5분을 정해 물을 마시거나 창밖을 보며 쉬어 보세요. GABA가 신경세포 사이 신호를 조절하는 물질이라는 설명을 읽으며 나에게 맞는 휴식 방법을 찾아보세요.',
  },
  sensory: {
    id: 'sensory',
    name: '자극이 많은 날',
    description: '사람 많은 곳이나 화면을 본 뒤 예민하거나 멍한 시간이 자주 있었어요.',
    suggestions: ['하루 한 번 알림과 화면을 끄고 조용한 공간에서 10분 쉬어 보세요.', '사람이 많은 뒤에는 바로 다음 일을 잡지 말고 물을 마시며 감각을 정리해 보세요.'],
    recoveryLevel: 'prepare',
    recoveryHeading: '사람과 화면에서 벗어날 시간을 만들어 보세요',
    recoveryDescription: '사람 많은 곳이나 화면을 본 뒤 예민하고 멍했다면 다음 일정 사이에 10분을 비워 보세요. 조용한 곳에서 눈과 귀를 쉬게 하고, GABA가 신경세포 사이 신호를 조절하는 물질이라는 설명을 천천히 읽어 보세요.',
  },
  unrested: {
    id: 'unrested',
    name: '아침에도 개운하지 않은 날',
    description: '잠을 자고 일어나도 피곤한 날이 많았어요.',
    suggestions: ['쉬는 공간의 빛·소리·온도가 편안한지 살펴보세요.', '쉬었던 시간과 다음 날의 느낌을 짧게 기록해 나에게 맞는 조건을 찾아보세요.'],
    recoveryLevel: 'prioritize',
    recoveryHeading: '아침을 급하게 시작하지 말고 회복부터 챙겨 보세요',
    recoveryDescription: '아침에도 피곤했다면 잠자는 시간과 방의 빛·소리를 먼저 확인해 보세요. GABA가 뇌의 신경세포 사이 신호를 조절하는 물질이라는 설명과 함께, 오늘은 잠자리에 드는 시간을 일정하게 맞춰 보세요.',
  },
  steady: {
    id: 'steady',
    name: '괜찮은 흐름을 이어가는 날',
    description: '최근 일주일은 잠과 휴식이 비교적 일정했어요.',
    suggestions: ['지금 편안하게 이어 가는 습관을 하나 적어 보세요.', '바쁜 날에도 지킬 수 있는 짧은 휴식 시간을 남겨 두세요.'],
    recoveryLevel: 'maintain',
    recoveryHeading: '지금 잘 되는 습관을 계속 지켜 보세요',
