...
if (!/canonical" href="https:\/\/kradavid\.github\.io\/cellpinda_GABA\/focus\//.test(focusHtml) || !/property="og:title" content="“너도 해봐” 1분 집중 신호 게임"/.test(focusHtml) || !/property="og:image" content="https:\/\/kradavid\.github\.io\/cellpinda_GABA\/assets\/focus-game-card\.png"/.test(focusHtml) || !/focus=1#focus-game|focus=1/.test(focusHtml) || !focusHtml.includes('24개') || !focusHtml.includes('게임 설명 보고 시작하기')) fail('focus invite page must expose the randomized, user-started game preview and app handoff');
