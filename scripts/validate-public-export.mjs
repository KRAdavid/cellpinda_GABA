...
if (!researchHtml.includes('운동 경험이 있는 남성 11명이 GABA 3g을 한 번 먹고 운동 없이 쉰 조건과 운동 조건에서 혈액 속 성장호르몬 수치를 살펴봤어요. 셀핀다 가바 1500 제품 정보와는 따로 확인해 주세요.') || researchHtml.includes('GABA와 단백질을 함께 사용한 연구')) fail('research static fallback must match the approved Powers study scope and separate its research amount from the product');
