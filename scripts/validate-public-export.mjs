...
if (!/<link rel="canonical" href="https:\/\/kradavid\.github\.io\/cellpinda_GABA\/products\/">/.test(productShareHtml) || !/<meta property="og:url" content="https:\/\/kradavid\.github\.io\/cellpinda_GABA\/products\/">/.test(productShareHtml) || !/<meta property="og:title" content="셀핀다 가바 1,500 · 제품 구성 보기">/.test(productShareHtml) || !productShareHtml.includes('assets/product-composition-1500.png') || !productShareHtml.includes('https://smartstore.naver.com/cellpinda/products/4701017202') || !productShareHtml.includes('../?view=products#products')) fail('product share page must expose product-specific metadata, preview image, and product/store destinations');
...
if (product.id !== 'gaba1500' || product.amountMg !== 1500 || product.servings !== 30 || product.category !== '기타가공품' || !isSmartStore(product.officialUrl)) fail('the public product must match the user-confirmed Smart Store 1500 product data');
