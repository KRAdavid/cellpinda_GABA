...
const publicMetadataKeys=[
  ...
  'searchThrough','studyCount','consumerScope','consumerSummary','consumerFinding','consumerContext','consumerDisclosure','consumerVisual','hopefulTakeaway',
];
