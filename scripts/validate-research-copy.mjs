...
if (!researchLibrary.includes('research-topic-cards') || !researchLibrary.includes('research-review-metrics') || !researchLibrary.includes("'research-review-2020', 'research-byun-2018'") || !researchLibrary.includes('setTopic(nextTopic)')) fail('research must lead with the 14-study review and expose directly selectable consumer topic cards');
