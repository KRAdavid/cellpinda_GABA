...
if (powers?.metadata?.consumerDisclosureStatus !== 'not_reported_in_pubmed_abstract' || powers.metadata?.fullTextDisclosureCheck !== 'required') fail('Powers study disclosure status must remain explicit until the full text is reviewed');
