...
for (const marker of ['숨의 감각을 느껴요', '생각은 지나가게 둬요', '다시 숨으로 돌아와요', '5분 숨 관찰 타이머']) requireMatch(fatigueGame, new RegExp(marker), `guided five-minute breathing rest marker ${marker} is missing`);
