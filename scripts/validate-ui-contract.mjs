...
for (const marker of ['공이 올라가는 동안 · 4초', '공이 위에서 옆으로 이동하는 동안 · 2초', '공이 내려가는 동안 · 6초', '공이 아래에서 옆으로 이동하는 동안 · 2초', 'BreathLineGuide', 'BREATH_LINE_PATH', 'M80 280 L300 70 L540 70 L760 280 L80 280', 'prefers-reduced-motion', '자연스럽게 호흡하세요']) requireMatch(fatigueGame, new RegExp(marker), `animated 4-2-6-2 breathing rest marker ${marker} is missing`);
