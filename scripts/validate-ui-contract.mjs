...
requireMatch(brainLoadEvidence, /brain-load-evidence-details[\s\S]*관련 연구 5편 더 보기[\s\S]*brain-load-evidence-grid/, 'brain-load evidence details must stay behind an optional consumer-friendly disclosure');
