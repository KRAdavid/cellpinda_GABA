...
for (const marker of ['집중 리듬 챌린지', 'Go/No-Go', '규칙 전환', '12번']) requireMatch(fatigueGame, new RegExp(marker), `advanced focus game marker ${marker} is missing`);
