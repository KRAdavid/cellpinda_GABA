...
requireMatch(app, /content\.reviews\?\.length \? <a href=\{REVIEW_DESTINATION_URL\}[\s\S]*?>구매자 후기 읽기/, 'hero product card must deep-link to the approved Smart Store review dialog');
