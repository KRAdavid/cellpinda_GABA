...
if (!(researchRoute.indexOf('<ResearchLibrary') >= 0 && !researchRoute.includes('research-route-product') && !/href="#products"|스마트스토어/.test(researchRoute))) fail('the research route must stay separate from product purchase prompts');
