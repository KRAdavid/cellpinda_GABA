...
for (let attempt = 1; attempt <= 12; attempt += 1) {
  try {
    ...
    assert.ok(consumerBundle.includes('잠드는 시간이 비교 캡슐을 먹은 주보다 평균 5분 짧게 기록됐어요.') && consumerBundle.includes('과제 뒤 뇌파와 활력 점수의 감소 폭이 비교 캡슐을 먹었을 때보다 작게 기록됐어요.') && consumerBundle.includes('연구에서 관찰된 내용') && consumerBundle.includes('연구에서 먹은 양: 하루 100mg') && consumerBundle.includes('연구에서 먹은 양: 100mg 1회') && consumerBundle.includes('셀핀다 제품에 적힌 양과는 다른 연구예요'), 'live consumer bundle must preserve plain-language research highlights and separate research amounts from product servings');
