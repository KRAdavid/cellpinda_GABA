...
for (let attempt = 1; attempt <= 12; attempt += 1) {
  try {
    ...
    assert.ok(publicResearchPayload.includes('비교 캡슐을 먹은 주보다 평균 잠드는 시간이 5분 짧게 기록됐어요.') && publicResearchPayload.includes('이 연구에서는 뇌파 대역과 활력 설문 점수의 감소 폭을 비교했어요. 비교 캡슐보다 작게 기록됐어요.') && publicResearchPayload.includes('연구에서 먹은 양: 하루 100mg'), 'live public research data must preserve plain-language highlights and separate research amounts from product servings');
