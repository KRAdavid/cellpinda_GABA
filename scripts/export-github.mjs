...
const consumerMetadataKeys=['studyType','population','sampleSize','dose','duration','comparison','outcome','productApplicability','question','searchThrough','studyCount','consumerScope','consumerSummary','consumerFinding','consumerDetail','consumerContext','consumerDisclosure','consumerVisual','hopefulTakeaway'];
