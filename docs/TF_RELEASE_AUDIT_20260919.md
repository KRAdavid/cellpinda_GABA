...
기술 배포는 완료 상태다. PR #107 병합 커밋 `7aea99dc76b353acd4a16f9f6be76c974fb1636b`의 [35567297107](https://github.com/KRAdavid/cellpinda_GABA/actions/runs/35567297107)에서 release verify·Pages·라이브 smoke·release status가 성공했고, 현재 공개 매니페스트가 같은 SHA를 가리킨다. 정적 사이트는 연구 6건·공개 주장 12개·제품 1개·후기 1개·공유 6개를 제공하며 Smart Store 단일 목적지와 750 제거를 유지한다. 공유 결과는 앱 셸과 결과 카드가 중복 이동하지 않고, 티저 지연 로딩 중에도 새 창 대체 경로를 제공한다.
