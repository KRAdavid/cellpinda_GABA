...
PR [#151](https://github.com/KRAdavid/cellpinda_GABA/pull/151)의 main 병합 커밋 `4a44cae9e83594ac8a1ce2a4c2bcd3b1ea700c7e`가 [배포 run 35618510420](https://github.com/KRAdavid/cellpinda_GABA/actions/runs/35618510420)에서 Pages 게시·라이브 smoke·release status까지 성공했다. 공개 [release-manifest.json](https://kradavid.github.io/cellpinda_GABA/release-manifest.json)은 HTTP 200이며 정적 모드·10개 경로·hash 63개·연구 6건·공개 주장 12개·제품 1개·후기 목적지 1개·Smart Store only·750 제거·내부 운영 스냅샷 제외·티저 `HOLD`를 확인한다.
