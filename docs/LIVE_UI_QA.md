...
PR #125·#126·#127·#128·#129·#130·#132·#134·#135·#136·#137·#138·#139·#141의 필수 검사(`release-verify`, `site-quality-verify`)가 통과한 뒤 관리자 병합을 진행했고, 보호 규칙은 병합 직후 복구했다. 최신 라이브 확인 스냅샷은 main `570a63efa7d3e044ceab7c199362bc3686ae3d7d`, 배포 실행 [35599044204](https://github.com/KRAdavid/cellpinda_GABA/actions/runs/35599044204)이며 `release-verify`·Pages 게시·라이브 smoke·`release-status`가 모두 성공했다. 최신 공개 판정은 [release-manifest.json](https://kradavid.github.io/cellpinda_GABA/release-manifest.json)의 `candidateSha`·검사 결과를 우선하고, 문서 전용 병합으로 SHA가 바뀌어도 이 문서의 스냅샷은 감사 이력으로 보존한다. Worker/D1은 비밀값 미설정으로 이번 공개본에서 계속 `skipped`다. 1분 체크 전 챌린지를 숨기는 흐름, 일반 GABA 연구 경계, 소비자용 비교 문구, B4 승인 전 티저 `HOLD`, `/products/` 직접 진입 제품 섹션 안착을 라이브에서 재검증했다.
