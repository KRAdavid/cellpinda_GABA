...
PR #125·#126·#127·#128·#129·#130·#132·#134·#135·#136의 필수 검사(`release-verify`, `site-quality-verify`)가 통과한 뒤 관리자 병합을 진행했고, 보호 규칙은 병합 직후 복구했다. 최신 main 커밋은 `212bc4c072caff816f44485237e92fffb818441b`, 배포 실행은 [35594459694](https://github.com/KRAdavid/cellpinda_GABA/actions/runs/35594459694)이며 `release-verify`·Pages 게시·라이브 smoke·`release-status`가 모두 성공했다. Worker/D1은 비밀값 미설정으로 이번 공개본에서 계속 `skipped`다. 1분 체크 전 챌린지를 숨기는 흐름, 일반 GABA 연구 경계, 소비자용 비교 문구, B4 승인 전 티저 `HOLD`, `/products/` 직접 진입 제품 섹션 안착을 라이브에서 재검증했다.
