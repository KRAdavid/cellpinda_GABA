...
PR [#151](https://github.com/KRAdavid/cellpinda_GABA/pull/151)을 관리자 우회로 병합한 뒤 보호 규칙을 즉시 복구했다. 최신 공개 판정은 [release-manifest.json](https://kradavid.github.io/cellpinda_GABA/release-manifest.json)의 HTTP 200 응답과 현재 `candidateSha`, 그리고 [배포 run 35618510420](https://github.com/KRAdavid/cellpinda_GABA/actions/runs/35618510420)을 우선한다. 현재 라이브 candidate SHA는 `4a44cae9e83594ac8a1ce2a4c2bcd3b1ea700c7e`다. 1분 체크 전 챌린지 비노출, 결과 후 오늘 해볼 행동 패널, 제품·후기 CTA, 일반 GABA 연구의 비교 대상·측정 항목을 풀어 쓴 소비자 문구, B4 승인 전 티저 `HOLD`, `/products/` 직접 진입 시 제품 섹션 자동 안착을 현재 애플리케이션 기준으로 삼는다.
